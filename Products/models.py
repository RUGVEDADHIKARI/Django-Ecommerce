...
class Product(BaseModel):
    ...
    color_variant=models.ManyToManyField(color_variant)
    size_variant=models.ManyToManyField(size_variant)
    ...
    def get_product_price_by_size(self, size):
        ...
        return self.price + size_obj.size_price
